...
class TableChoosePatient extends StatefulWidget {
  final PatientViewModel patientViewModel;
  const TableChoosePatient({
    Key? key,
    required this.patientViewModel,
  }) : super(key: key);

  @override
  State<TableChoosePatient> createState() => _TableChoosePatientState();
}

class _TableChoosePatientState extends State<TableChoosePatient> {
  int currentPage = 0;
  int numPage = 1;
  int? amountData;
          ...
          child: ElevatedButton(
            onPressed: () {
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                  builder: (context) => const ScheduleScreenAdmin(),
                ),
              );
            },
